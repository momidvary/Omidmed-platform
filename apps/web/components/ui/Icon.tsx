...
const paths: Record<string, React.ReactNode> = {
  ...
  treatment: (
    <>
      ...
      <path d="M5 8h14" />
      <path d="M7 3h10" />
      <path d="M6 21h12a0 0 0 0 0 0 0V8H6v13Z" />
    </>
  ),
  exercise: (
    <>
  ...
  chat: (
    <>
      <path d="M21 11.5a8.38 8.38 0 0 1-8.5 8.5 9.4 9.4 0 0 1-4-.9L3 21l1.9-5.5a8.38 8.38 0 0 1-.9-4A8.5 8.5 0 0 1 12.5 3 8.38 8.38 0 0 1 21 11.5Z" />
    </>
  ),
  flag: (
    <>
  ...
  education: (
    <>
      ...
      <path d="M7 9v5c0 1 2 3 5 3s5-2 5-3V9" />
      <path d="M21 7v6" />
    </>
  ),
  settings: (
